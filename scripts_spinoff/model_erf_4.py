...
model_name = "erf4_rscv"+str(random_state_cv)+'_'+criterion+'_'+str(n_estimators)+'_'+str(max_depth)+'_'+str(min_leaf_split)
    
train, test, target, test_ids = _import_data.gen_data_7()
